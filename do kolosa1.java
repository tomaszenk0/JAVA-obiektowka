...
//Stwórz klasę bazową Person z prywatnym polem firstName oraz chronionym polem lastName. Następnie stwórz klasę Employee, która dziedziczy po klasie Person. W klasie Employee próbuj odnieść się do obu pól i zauważ, które z nich są dostępne.Na bazie klasy Person z poprzedniego podpunktu, stwórz metody dostępowe (gettery) dla obu pól. W klasie Employee stwórz metodę displayData, która korzysta z tych metod dostępowych, aby wypisać informacje o pracowniku. Zastanów się, dlaczego metody dostępowe są używane do dostępu do prywatnych pól.
public class Person {
    ...
    // Gettery dla pól firstName i lastName
    public String getFirstName() {
        return firstName;
    }
    ...
    class Employee extends Person
    {
        ...
        public void displayData() {
            // Nie możemy bezpośrednio odwołać się do pola firstName, jest ono prywatne w klasie Person
            // Natomiast możemy odwołać się do pola lastName, ponieważ jest chronione (protected)
            // lastName dostępne jest w klasie dziedziczącej (Employee) z klasy bazowej (Person)
